...
#print(isValidWord('apple', {'a':1, 'p':2, 'l':2, 'm':1, 'e':1, 'i':1}, loadWords()))
...
#print(calculateHandlen({'a':1, 'p':2, 'l':2, 'm':1, 'e':1, 'i':1}))
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        elif not(isValidWord(userWord, hand, wordList)):
...
def playGame(wordList):
    ...
    # Establish how many hands have been played - initially 0
    handsPlayed = 0
    hand = {}
